        ...
        <View style={styles.container}>
            {question.choices.map((choice, index) => (
                ...
                >
                    ...
                    >
                        <img
                            style={(!isEditable && userAnswer === index && question.answer === userAnswer) ? styles.highlightedStyle : styles.defaultStyle}
                        ...
                        <img
                            style={(!isEditable && userAnswer === index) ?
                                (question.answer != index ? styles.highlightedStyle : styles.defaultStyle) :
                                (!isEditable && question.answer === index ? styles.defaultStyle : styles.invisible)}
                        ...
                        <img
                            style={(!isEditable && userAnswer != index && question.answer === index) ? styles.highlightedStyle : styles.defaultStyle}
